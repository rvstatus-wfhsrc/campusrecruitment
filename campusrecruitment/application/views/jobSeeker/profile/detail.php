	...
	<body>
	    <div>
			<ol class="breadcrumb mb-1 ml-4 w95">
				<li class="breadcrumb-item"><i class="fa fa-user fa-btn mt3"></i><?php echo lang('lbl_jobSeeker'); ?><span class ="dot detailScrClr">&bull;</span><span class="detailScrClr"><?php echo lang('lbl_detail'); ?></span></li>
