        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="card shadow-lg border-0 rounded-lg mt-4">
                    <div class="card-header"><h3 class="text-center font-weight-light"><?php echo lang('lbl_resetPassword'); ?></h3></div>
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="offset-md-4 col-md-6">
                                    <button type="submit" class="btn bg-primary text-white resetProcess">
                                        <i class="fa fa-btn fa-refresh"></i><?php echo lang('lbl_resetPassword'); ?>
                                    </button>
                                </div>
                            </div>
                        <?php echo form_close();?>
